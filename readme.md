...
Selection of digital PWM 0-10v or analog 0-10v output can be made by onboard jumpers for each individual port labeled J1-J4. Place the jumper from the center pin to the pin labeled "PWM" for digital or place the jumper from the center pin to the pin labeled "Analog" for analog output.
